...
import imgC from "../../assets/image/l1/png/usa-content-2.png";
            ...
            >
              ...
              <div className="content-2 pl-lg-10 pl-0 d-flex flex-column justify-content-center h-100 pt-lg-0 pt-11 pr-md-13 pr-xl-15 pr-xxl-25 pr-0">
                ...
                <p className="text-dodger font-size-4 font-weight-semibold mb-8">
                  Worried about job security in the competetive USA job market?
                </p>
                <h2 className="font-size-9 mb-8">
                  USA has some of the best job opportunities for students
                </h2>
                <p className="text-default-color font-size-5 mb-12">
                Half the students who work during term time earn more than $100 a week - and some earn up to $20,000 a year
                </p>
