            ...
            >
              ...
              <div className="content-2 pr-lg-5 pr-xl-18 pr-xxl-10 text-center text-lg-left">
                ...
                <p className="text-white font-size-4 font-weight-semibold mb-8">
                  Looking for a breakthrough in your consultancy business?
                </p>
                <h2 className="font-size-9 text-white mb-8">
                  GSC has over 30 years of experience doing just that
                </h2>
                <p className="text-white font-size-5 mb-12">
                 Our Propeitory System allows consultants and students alike to test eligibility and apply to the best schools in the fastest time possible. 
                </p>
