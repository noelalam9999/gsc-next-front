 ...
 const success = () => {
    alert("Student has been updated");
       ...
       if(newImage.length!=0){ 
        ...
        .then(res => {
          alert("Latest Certificate Uploaded");
        })
        .catch(err => console.log(err))}
         ...
         let form_data = new FormData();
         form_data.append('image', newImage2, newImage2.name);
         form_data.append('email', email);
         ...
         .then(res => {
           alert("IELTS Cerfiticate Uploaded");
         })
         .catch(err => console.log(err))
       }
        ...
        if(newImage3.length!=0){
        let form_data = new FormData();
        form_data.append('image', newImage3, newImage3.name);
        form_data.append('email', email);
...
const handleSubmit = (item) => { 
  ...
  item.Desiredlevel=typeof Desiredleveldata == "object" ? DesiredSubjectdata.value : DesiredSubjectdata,
                          ...
                          <div className="col-lg-6">
                            <div className="form-group">
                              ...
                              <input type="file"
                                     id="image"
                                     accept="image/png, image/jpeg" 
                                     onChange={handleImageChange3} required/>
                            </div>
                          </div>
                        </div>
                        <div className="row mb-xl-1 mb-9">
