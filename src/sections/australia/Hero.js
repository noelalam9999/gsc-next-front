...
import imgP from "../../assets/image/l1/png/hero-aus.png";
        ...
        <div className="container">
          <div  className="row position-relative align-items-center">
            ...
            >
              ...
              <div className="">
                {/* <!-- .search-form --> */}
                <form action="/search/australia/all" className="search-form shadow-6">
                  <div className="filter-search-form-1 bg-white rounded-sm shadow-4">
                    ...
                    <div className="button-block">
                      <button onClick={()=>router.push(`/search/australia/all`)} className="btn btn-primary line-height-reset h-100 btn-submit w-100 text-uppercase">
                        Search
                      </button>
                    </div>
                    {/* <!-- ./Hero Button --> */}
