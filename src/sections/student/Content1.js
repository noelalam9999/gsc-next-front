          ...
          <div className="row align-items-center justify-content-center">
            ...
            >
              <div className="position-relative px-xl-20 pr-md-15 pr-9">
                {/* <!-- content img start --> */}
                <img src="https://res.cloudinary.com/american-international-university-bangladesh/image/upload/v1624492732/pexels-monstera-6281880_ifgfbi.jpg" alt="" className="w-100 rounded-4" />
                {/* <!-- content img end --> */}
                {/* <!-- abs-content start --> */}
                <div className="abs-content pos-abs-br mb-30 mr-8 rounded-4 rotate-n10 border-10 border-white shadow-2">
                  <img
                    height="125px"
                    src="https://res.cloudinary.com/american-international-university-bangladesh/image/upload/v1621063970/pexels-anna-shvets-4226256_hk6ugg.jpg"
                    alt=""
            ...
            >
              ...
              <div className="content-2 pl-xl-10 d-flex flex-column justify-content-center h-100 pt-lg-0 pt-15 pr-xl-10 pr-xxl-0">
                ...
                <h2 className="font-size-8 mb-7 pr-xs-13  pr-md-0 pr-sm-8">
                  Over <span className="text-green">20k+ people</span> got recruited through <div>Global Study Contacts</div>
                </h2>
                <p className="text-default-color font-size-5 mb-7 mb-lg-12 pr-xxl-13 pr-lg-0 pr-md-10">
                  Students from 15+ Countries have found their dream study destination with the help of GSC
                </p>
