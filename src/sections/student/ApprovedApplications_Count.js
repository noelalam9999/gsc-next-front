 ...
 const { authUser, loading,signOut } = useAuth();
  ...
  useEffect(() =>  {
    ...
    try {
      ...
      let filtered_application = todoList.filter(function(val, i, a) {return val.client_name==authUser;})
      let filtered_approved_application = filtered_application.filter(function(val, i, a) {return val.status=="approved";})

      
      console.log(approved)
      setList(filtered_approved_application.length)
