            ...
            >
              ...
              <div className="content-2 pr-lg-5 pr-xl-18 pr-xxl-10 text-center text-lg-left">
                ...
                <p className="text-white font-size-4 font-weight-semibold mb-8">
                  Looking for an experienced consultancy agency to help you find the right students for your campus?
                </p>
                <h2 className="font-size-9 text-white mb-8">
                  GSC has over 30years of experience doing just that
                </h2>
                <p className="text-white font-size-5 mb-12">
                  Global Study Contacts has agents all over the world focusing solely on bridging the gap between your campus and students
                </p>
