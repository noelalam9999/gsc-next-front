...
import Header from "../../components/Header/HeaderProfileStudent";
...
class StudentRegistrationChild extends Component {
...
{    let form_data2 = new FormData();
    ...
    form_data2.append('email', item.email);
...
fail =() =>{
  ...
  alert("Please fill up the required fields. The ones with the asterisk");
}
                      ...
                      <fieldset>
                        ...
                        <div className="col-lg-6">
                            <div className="form-group">
                              ...
                              onChange={this.handleImageChange3} required/>
                            </div>
                          </div>
                          <div className="col-lg-6">
                            <div className="form-group">
...
export default withRouter(StudentRegistrationChild);
