...
import SidebarDashboardStudent from "../../components/SidebarDashboard/SidebarDashboardInstitute";
...
class UniRegistration extends Component {
...
console.log(item)
  ...
  axios
    ...
    form_data.append('mobile', this.props.user);
                          ...
                          <div className="col-lg-6">
                            <div className="form-group">
                              ...
                              <input
                                ...
                                onChange={this.handleChange}
                                value={this.state.activeItem.IELTSRequirement}
                              />
                            </div>
                          </div>
                          <div className="col-lg-6">
