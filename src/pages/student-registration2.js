...
const SignUp = () => {
  ...
  const success = () => {
    alert(
      'Your Data has been recorded. We will suggest you some great Institutes shortly'
    );
  };
  const onSubmit = (event) => {
    ...
    if (
      ...
      axios
        ...
        .catch((err) =>
          alert(
            'Please fillup the mandatory fields, the ones with the asterisks * '
          )
        );
              ...
              <div className='row'>
                <div className='col-xxxl-9 px-lg-13 px-6'>
                  <h5 className='font-size-6 font-weight-semibold mb-11'>
                    Please fill up the details so we can find the right
                    University for you
                  </h5>
                          ...
                          <div className='col-lg-6'>
                            <div className='form-group'>
                              ...
                              <Select
                                ...
                                border={false}
                                name='gender'
                                onChange={updateSelectField} // ---------------------------------- Edited
                              />
                            </div>
                          </div>
                        </div>
