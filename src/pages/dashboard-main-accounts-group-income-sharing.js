        ...
        <div className="dashboard-main-container mt-25 mt-lg-31">
          ...
          <div className="row mb-1">
              <div className="col-xxl-3 col-xl-4 col-lg-6 col-sm-4">
                {/* <!-- Single Category --> */}
                <a
                  href="/dashboard-main-accounts-payments"
              ...
              <div className="col-xxl-3 col-xl-4 col-lg-3 col-sm-3">
                {/* <!-- Single Category --> */}
                <a
                  href="/dashboard-main-accounts-invoices"
                  className="media bg-white rounded-4 pl-8 pt-9 pb-9 pr-7 hover-shadow-1 mb-9 shadow-8"
                >
              ...
              <div className="col-xxl-3 col-xl-4 col-lg-3 col-sm-3">
                {/* <!-- Single Category --> */}
                <a
                  href="/dashboard-main-accounts-group-invoice"
                  className="media bg-white rounded-4 pl-8 pt-9 pb-9 pr-7 hover-shadow-1 mb-9 shadow-8"
                >
                  {/* <div className="text-pink bg-pink-opacity-1 circle-56 font-size-6 mr-7">
                    <i className="fas fa-user"></i>
              ...
              <div className="col-xxl-3 col-xl-4 col-lg-3 col-sm-3">
                {/* <!-- Single Category --> */}
                <a
                  href="/dashboard-main-accounts-group-invoice-schedules"
                  className="media bg-white rounded-4 pl-8 pt-9 pb-9 pr-7 hover-shadow-1 mb-9 shadow-8"
                >
                  {/* <div className="text-pink bg-pink-opacity-1 circle-56 font-size-6 mr-7">
                    <i className="fas fa-user"></i>
            ...
            <div className="mb-14">
              <div className="row mb-11 align-items-center">
                <div className="col-lg-6 mb-lg-0 mb-4">
                  <h3 className="font-size-6 mb-0">Accounts Group Income Sharing</h3>
                </div>
                <div className="col-lg-6">
                  <div className="d-flex flex-wrap align-items-center justify-content-lg-end">
                    <p className="font-size-4 mb-0 mr-6 py-2">Filter by Month:</p>
