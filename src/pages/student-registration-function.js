...
const StudentRegistration = () => {
  let { authUser, loading,signOut } = useAuth();
  ...
  const [prev_qualification,setprev_qualification] = useState([""])
  const [IELTSBand,setIELTSBand] = useState([""])
  const [Desiredlevel,setDesiredlevel] = useState([""])
  const [StudyDestination,setStudyDestination] = useState([""])
  const [IntendedSemester,setIntendedSemester] = useState([""])
...
DesiredSubject) => {
  ...
  record.prev_qualification=prev_qualification;
                        ...
                        <div className="row mb-xl-1 mb-9">
                          ...
                          <div className="col-lg-6">
                            <div className="form-group">
                              ...
                              <select value={country} onChange={(event) => setcountry(event.target.value)} className="form-control pl-0 arrow-3 w-100 font-size-4 d-flex align-items-center w-100 ">
...
<option   value={item.value}>{item.label}</option>  
                              ...
                              {/* <Select
                                ...
                                onChange={(event) => setbirth_month(event.target.value)}
                                value={birth_month}
                              /> */}
                            </div>
                          </div>
...
<option   value={item.value}>{item.label}</option>  
                              ...
                              {/* <Select
                                ...
                                className="form-control pl-0 arrow-3 w-100 font-size-4 d-flex align-items-center w-100 "
                                border={false}
                                onChange={(event) => setbirth_year(event.target.value)}
                                value={birth_year}
                              /> */}
                            </div>
                          </div>
                          ...
                          <div className="col-lg-6 mb-xl-0 mb-7">
                            <div className="form-group position-relative">
                              ...
                              <Select
                                ...
                                className="form-control pl-0 arrow-3 w-100 font-size-4 d-flex align-items-center w-100 "
                                border={false}
                                onChange={(event) => setprev_qualification(event.target.value)}
                                value={prev_qualification}
                              />
                            </div>
                          </div>
                          <div className="col-lg-6">
                          ...
                          <div className="col-lg-6 mb-xl-0 mb-7">
                            <div className="form-group position-relative">
                              ...
                              <Select
                                ...
                                className="form-control pl-0 arrow-3 w-100 font-size-4 d-flex align-items-center w-100 "
                                border={false}
                                onChange={(event) => setIntendedSemester(event.target.value)}
                                value={IntendedSemester}
                              />
                            </div>
                          </div>
                          <div className="col-lg-6">
                            <div className="form-group position-relative">
                              ...
                              <Select
                                ...
                                className="form-control pl-0 arrow-3 w-100 font-size-4 d-flex align-items-center w-100 "
                                border={false}
                                onChange={(event) => setDesiredSubject(event.target.value)}
                        ...
                        <input
                              ...
                              onClick={() => handleSubmit(name, mobile, country, gender,birth_date,birth_month,birth_year,address1,address2,prev_qualification,IELTSBand,Desiredlevel,StudyDestination,IntendedSemester,DesiredSubject)}
                         />
                      </fieldset>
                    </form>
                  </div>
