          ...
          <div className="container">
            <div className="row mb-7">
              <div className="col-xxl-3 col-xl-4 col-lg-6 col-sm-4">
                {/* <!-- Single Category --> */}
                <a
                  href="/dashboard-main-office-checkin-waiting"
              ...
              <div className="col-xxl-3 col-xl-4 col-lg-3 col-sm-3">
                {/* <!-- Single Category --> */}
                <a
                  href="/dashboard-main-office-checkin-attending"
                  className="media bg-white rounded-4 pl-8 pt-9 pb-9 pr-7 hover-shadow-1 mb-9 shadow-8"
                >
              ...
              <div className="col-xxl-3 col-xl-4 col-lg-6 col-sm-3">
                {/* <!-- Single Category --> */}
                <a
                  href="/dashboard-main-office-checkin-completed"
                  className="media bg-white rounded-4 pl-8 pt-9 pb-9 pr-7 hover-shadow-1 mb-9 shadow-8"
                >
              ...
              <div className="col-xxl-3 col-xl-4 col-lg-6 col-sm-4">
                {/* <!-- Single Category --> */}
                <a
                  href="/dashboard-main-office-checkin-all"
                  className="media bg-white rounded-4 pl-8 pt-9 pb-9 pr-7 hover-shadow-1 mb-9 shadow-8"
                >
            ...
            <div className="mb-14">
              <div className="row mb-11 align-items-center">
                <div className="col-lg-6 mb-lg-0 mb-4">
                  <h3 className="font-size-6 mb-0">Office Check-in Attending</h3>
                </div>
